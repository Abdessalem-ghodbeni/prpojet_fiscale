...
public class SecurityConfiguration {
    ...
    public SecurityConfiguration(JwtAuthenticationFilter jwtAuthFilter, IUserServices userServices) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(req ->
                        req.requestMatchers("/**")
                                .permitAll()
                                .requestMatchers("/**").hasAnyRole(Role.ADMIN.name(), Role.SOCIETE.name(),Role.COMPTABLE.name())
                                .anyRequest()
                                .authenticated()
                )
